...
// Recursos humanos: el expediente de quien trabaja, sus ausencias y el
// registro de jornada que la ley obliga a llevar. Vive aparte de
// /profesionales, que es el perfil operativo (zona, disponibilidad, foto).
...
equipoRouter.get("/:profesionalId/documentos", async (req, res) => {
...
equipoRouter.post("/:profesionalId/documentos", soloGestion, async (req, res) => {
...
equipoRouter.delete("/documentos/:id", soloGestion, async (req, res) => {
...
equipoRouter.get("/ausencias", async (req, res) => {
...
equipoRouter.post("/:profesionalId/ausencias", async (req, res) => {
...
equipoRouter.post("/ausencias/:id/estado", soloGestion, async (req, res) => {
...
equipoRouter.get("/registros", async (req, res) => {
  const usuario = req.usuario!;
  if (esGestorOrganizacion(usuario)) {
...
equipoRouter.post("/registros/cerrar", soloGestion, async (req, res) => {
...
equipoRouter.post("/registros/:id/conforme", async (req, res) => {
